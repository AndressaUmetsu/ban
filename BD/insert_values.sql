...
INSERT INTO TipoQuartos (nome, preco) VALUES
	('single', 25),
	('duplo', 25),
	('casal', 25),
	('suite', 25);

INSERT INTO Hotels (nome, endereco, telefone) VALUES
...
INSERT INTO Empregados (nome) VALUES
	('Sen'),
	('Lin');

INSERT INTO TipoServicos (nome, custo) VALUES
	('Malabarista', 100),
	('Exorcista', 1000),
	('Waifu', 250);
...
INSERT INTO Servicos (idTipoServico, idCliente, numQuarto, idHotel, dataCheckIn, data, hora) VALUES
	(1, 1, 1, 1, '10/12/2016', '10/13/2016', '10:10');
