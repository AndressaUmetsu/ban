...
class HotelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hotel" do
    assert_difference('Hotel.count') do
      post hotels_url, params: { hotel: { endereco: @hotel.endereco, nome: @hotel.nome, telefone: @hotel.telefone } }
    end
  ...
  test "should update hotel" do
    patch hotel_url(@hotel), params: { hotel: { endereco: @hotel.endereco, nome: @hotel.nome, telefone: @hotel.telefone } }
