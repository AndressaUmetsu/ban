...
class TipoServicosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tipo_servico" do
    assert_difference('TipoServico.count') do
      post tipo_servicos_url, params: { tipo_servico: { custo: @tipo_servico.custo, nome: @tipo_servico.nome } }
    end
  ...
  test "should update tipo_servico" do
    patch tipo_servico_url(@tipo_servico), params: { tipo_servico: { custo: @tipo_servico.custo, nome: @tipo_servico.nome } }
